...
export default class NameRealView extends Component {
    ...
    nameView = () => {
        ...
        if (isEmptyObject(user_extra)) {
            return ( <View
                style={{height:39,alignItems:'center',flexDirection:'row',
            ...
            return ( <View
                ...
                style={{marginLeft:18,marginRight:18,height:67,
    ...
    _showStatus = () => {
        ...
        if (user_extra.status !== Verified.INIT) {
            return (  <View style={{borderRadius:2,backgroundColor:'#cccccc',
