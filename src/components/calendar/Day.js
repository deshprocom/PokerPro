...
export default class Day extends Component {
  ...
  dayTextStyle = (isWeekend, isSelected, isToday, event) => {
    ...
    if (isToday && !isSelected) {
      ...
      dayTextStyle.push(styles.currentDayText, customStyle.currentSelected);
    } else if (isToday || isSelected) {
        dayTextStyle.push(styles.selectedDayText, customStyle.currentSelected);
    }
      ...
      <TouchableOpacity
        ...
        <View style={[styles.dayButton, customStyle.dayButton]}>
          <View style={this.dayCircleStyle(isWeekend, isSelected, isToday, event)}>
            <Text
                style={this.dayTextStyle(isWeekend, isSelected, isToday, event)}>{caption}</Text>
          </View>
          {showEventIndicators &&
            <View style={[
