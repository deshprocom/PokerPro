...
elsif ENV['IDEVICENAME']=='iphone'
	caps = Appium.load_appium_txt file: File.expand_path("./../iphone/appium.txt", __FILE__), verbose: true
else
...
# Before do
#   unless $driver_started
#     $driver_started = true
#     $driver.start_driver
#   end
# end

# Before(:all) { $driver.start_driver }
at_exit { $driver.driver_quit }

Before("@reset_driver") do
  puts "@reset_driver Scenario ...."
	$driver.restart
end